...
import { KeyRound, Eye, EyeOff, Shield, Mail, Lock } from "lucide-react";
...
const Settings = () => {
  ...
  const handleUpdate = async (e) => {
    ...
    setSaving(true);
    try {
      const payload = { current_password: currentPassword, verification_code: verificationCode, new_password: newPassword };
