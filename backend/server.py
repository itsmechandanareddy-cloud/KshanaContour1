...
async def seed_production_data(secret: str = ""):
    ...
    # ===== ORDERS DATA =====
    from orders_data import ORDERS_DATA
    ...
    expense_entries = [
        ...
        {"date":"2026-03-21","order":"NA","reason":"Worker salaries","paid_to":"Srinivasa Reddy","chandana":0,"akanksha":0,"sbi":16180,"mode":"UPI","comments":"Phonepe","type":"expense"},
        {"date":"2026-03-21","order":"NA","reason":"Worker salaries","paid_to":"Srinivasa Reddy","chandana":0,"akanksha":0,"sbi":7000,"mode":"UPI","comments":"Phonepe","type":"expense"},
        {"date":"2026-03-21","order":"NA","reason":"Dad Salary","paid_to":"Srinivasa Reddy","chandana":0,"akanksha":0,"sbi":10000,"mode":"UPI","comments":"Phonepe","type":"expense"},
        {"date":"2026-03-30","order":"NA","reason":"Falls, Kuchchu and Zig Zag","paid_to":"Anitha","chandana":0,"akanksha":0,"sbi":500,"mode":"UPI","comments":"Phonepe","type":"expense"},
        {"date":"2026-04-04","order":"NA","reason":"Boutique rent","paid_to":"Venkatanarayana","chandana":0,"akanksha":0,"sbi":12000,"mode":"UPI","comments":"Phonepe","type":"expense"},
        {"date":"2026-04-06","order":"NA","reason":"Worker salaries","paid_to":"Srinivasa Reddy","chandana":0,"akanksha":0,"sbi":21900,"mode":"UPI","comments":"Phonepe","type":"expense"},
        {"date":"2026-04-07","order":"NA","reason":"Room rent","paid_to":"Srinivasa Reddy","chandana":0,"akanksha":0,"sbi":8000,"mode":"UPI","comments":"Phonepe","type":"expense"},
        {"date":"2026-04-09","order":"NA","reason":"Falls, Kuchchu and Zig Zag","paid_to":"Anitha","chandana":0,"akanksha":0,"sbi":1250,"mode":"UPI","comments":"Phonepe","type":"expense"},
        {"date":"2026-04-13","order":"NA","reason":"Worker salaries","paid_to":"Srinivasa Reddy","chandana":0,"akanksha":0,"sbi":21000,"mode":"UPI","comments":"Phonepe","type":"expense"},
    ]
    ...
    employees_data = [
        ...
        {"name":"Anitha","role":"Worker","phone":"","pay_type":"weekly","salary":0,"payments":[
            ...
            {"amount":500,"date":"2026-03-30","mode":"UPI","notes":"Falls, Kuchchu, Zig Zag (via Phonepe)"},
            {"amount":1250,"date":"2026-04-09","mode":"UPI","notes":"Falls, Kuchchu, Zig Zag (via Phonepe)"},
        ]},
        ...
        {"name":"Srinivasa Reddy","role":"Manager","phone":"","pay_type":"monthly","salary":10000,"payments":[
            ...
            {"amount":16180,"date":"2026-03-21","mode":"UPI","notes":"Worker salaries (via Phonepe)"},
            {"amount":7000,"date":"2026-03-21","mode":"UPI","notes":"Worker salaries (via Phonepe)"},
            {"amount":10000,"date":"2026-03-21","mode":"UPI","notes":"Dad Salary (via Phonepe)"},
            {"amount":21900,"date":"2026-04-06","mode":"UPI","notes":"Worker salaries (via Phonepe)"},
            {"amount":8000,"date":"2026-04-07","mode":"UPI","notes":"Room rent (via Phonepe)"},
            {"amount":21000,"date":"2026-04-13","mode":"UPI","notes":"Worker salaries (via Phonepe)"},
        ]},
